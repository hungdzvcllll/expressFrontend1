...
const AdminTablePage: React.FC = () => {
  ...
  const addTable = async (capacity: number, status: boolean) => {
    const res = await fetch(`https://githubaction-production.up.railway.app/table/add`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + localStorage.getItem("token"),
  ...
  const stopTable = async (id: number) => {
    const res = await fetch(
      `https://githubaction-production.up.railway.app/table/stop/${id}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  const startTable = async (id: number) => {
    const res = await fetch(
      `https://githubaction-production.up.railway.app/table/start/${id}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
